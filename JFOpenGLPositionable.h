...
@class JFOpenGLVertex;
@class JFOpenGLMatrix;


/*
 * The protocol to which all positionable OpenGL models must adhere.
 */
@protocol JFOpenGLPositionable <NSObject>
